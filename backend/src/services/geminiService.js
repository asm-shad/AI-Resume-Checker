...
function buildPrompt(rawText, targetRole) {
  return [
    ...
    "Score the resume from 0 to 100 based on ATS readiness.",
    "Consider keyword match, parseable formatting, quantified impact, and clarity.",

    "",

    "Return exactly 5 prioritized issues.",
    "Return exactly 5 standout strengths.",
    "Return 5 to 10 weak bullets rewritten to be stronger, quantified, and ATS-friendly.",

    "",

    "Rewrites must preserve the original meaning.",
    "Each rewrite must include a one-line rationale.",

    "",

    "Identify keywords clearly present in the resume.",
    "Identify notable keywords missing for the target role.",

    "",

    "Be specific and evidence-based.",
    "Use actual phrasing from the resume when explaining issues and strengths.",
    "Do not invent experience, skills, achievements, or technologies.",
